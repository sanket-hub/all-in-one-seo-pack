...
$generated_i18n_strings = array(
	...
	// Reference: src/vue/router/index.js:94
	...
	// Reference: src/vue/pages/dashboard/views/Main.vue:246
	...
	// Reference: src/vue/pages/dashboard/views/Main.vue:245
	...
	// Reference: src/vue/pages/dashboard/views/Main.vue:242
	...
	// Reference: src/vue/pages/link-assistant/views/Main.vue:43
	...
	// Reference: src/vue/components/common/core/add-redirection/Index.vue:466
	...
	// Reference: src/vue/pages/local-seo/views/pro/locations/Activate.vue:25
	// Reference: src/vue/pages/local-seo/views/pro/locations/BusinessInfo.vue:129
	// Reference: src/vue/pages/local-seo/views/pro/locations/Update.vue:25
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:348
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:361
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:346
	__( 'Add New Redirection', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:347
	__( 'Search URLs', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:349
	__( 'Check Redirect', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:351
	__( 'Are you sure you want to delete this redirect?', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:352
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:354
	__( 'Yes, I want to delete this redirect', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:355
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:357
	__( 'Rules', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/CustomRules.vue:109
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:358
	__( 'Custom Rules', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/CustomRules.vue:113
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:359
	__( 'Regex', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:360
	__( 'Check redirect for', 'all-in-one-seo-pack' ),

	// Reference: src/vue/mixins/TruSeoScore.js:16
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:362
	__( 'Errors', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:363
	__( 'Response Code', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:366
	__( 'Redirected By', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:367
	__( 'Custom URL', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:368
	__( 'Test Redirect', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:369
	__( 'Woohoo! Your redirect worked perfectly!', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:370
	__( 'Whoops! Your URL failed to redirect properly.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:371
	__( 'Expected', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:372
	__( 'Result', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:374
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:377
	__( 'Enable', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:378
	__( 'Disable', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:379
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:410
	__( 'Source URL', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:414
	__( 'Target URL', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:418
	...
	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:428
	__( 'Group', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:469
	__( 'Filter by Group', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:471
	__( 'All Groups', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:593
	__( 'Pass through', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/redirects/Redirects.vue:665
	...
	// Reference: src/vue/pages/link-assistant/views/Settings.vue:140
	__( 'Post Types', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:141
	...
	// Reference: src/vue/pages/link-assistant/views/Settings.vue:158
	...
	// Reference: src/vue/pages/post-settings/views/Main.vue:62
	...
	// Reference: src/vue/pages/post-settings/views/Facebook.vue:236
	__( 'Image Source', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/post-settings/views/Facebook.vue:237
	...
	// Reference: src/vue/pages/redirects/views/lite/redirects/Redirects.vue:53
	...
	// Reference: src/vue/pages/link-assistant/views/pro/overview/Activate.vue:52
	// Reference: src/vue/pages/link-assistant/views/pro/overview/Update.vue:58
	...
	// Reference: src/vue/pages/link-assistant/views/pro/overview/Activate.vue:53
	// Reference: src/vue/pages/link-assistant/views/pro/overview/Update.vue:59
	...
	// Reference: src/vue/components/common/core/add-redirection/Index.vue:272
	// Reference: src/vue/pages/redirects/views/pro/Logs404.vue:196
	__( 'Add Redirects', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Index.vue:272
	// Reference: src/vue/pages/redirects/views/pro/Logs404.vue:200
	__( 'Add Redirect', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Logs404.vue:201
	__( 'Add New Redirections', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Logs404.vue:243
	...
	// Reference: src/vue/pages/post-settings/views/LinksSideBar.vue:27
	...
	// Reference: src/vue/components/common/core/add-redirection/Index.vue:233
	...
	// Reference: src/vue/components/common/core/add-redirection/Index.vue:236
	...
	// Reference: src/vue/components/common/core/add-redirection/Index.vue:269
	__( 'Source URL\'s', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Index.vue:287
	...
	// Reference: src/vue/components/common/core/add-redirection/Index.vue:296
	/* Translators: 1 - Adds a html tag with an option like: <code>^</code>. */
	__( 'Your target URL contains the invalid character(s) %1$s', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Index.vue:309
	__( 'Your URL appears to contain a domain inside the path: %1$s. Did you mean to use %2$s instead?', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Index.vue:423
	__( 'A redirect already exists for this source URL. To make changes, edit the original instead.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Index.vue:465
	__( 'Moved Permanently', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Index.vue:480
	...
	// Reference: src/vue/components/common/core/add-redirection/Url.vue:202
	__( 'Please enter a valid relative source URL.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:206
	__( 'Permalinks are not currently supported.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:210
	__( 'This redirect is supported using the Relocate Site feature under Full Site Redirect tab.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:225
	__( 'Your source is the same as a target and this will create a loop.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:243
	__( 'Anchor values are not sent to the server and cannot be redirected.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:248
	...
	// Reference: src/vue/components/common/core/add-redirection/Url.vue:254
	/* Translators: 1 - Adds a html tag with an option like: <code>^</code>, 2 - Adds a html tag with an option like: <code>^</code>. */
	...
	// Reference: src/vue/components/common/core/add-redirection/Url.vue:259
	/* Translators: 1 - Adds a html tag with an option like: <code>^</code>, 2 - Adds a html tag with an option like: <code>^</code>. */
	__( 'The caret %1$s should be at the start. For example: %2$s', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:264
	/* Translators: 1 - Adds a html tag with an option like: <code>^/</code> */
	__( 'The source URL should probably start with a %1$s', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:269
	/* Translators: 1 - Adds a html tag with an option like: <code>^/</code> */
	__( 'The dollar symbol %1$s should be at the end. For example: %2$s', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/add-redirection/Url.vue:275
	...
	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:355
	__( 'Custom Rules', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:356
	__( 'Regex', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/components/common/base/WpTable.vue:383
	...
	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:114
	__( 'Widget', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/components/common/base/WpTable.vue:407
	__( 'of', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/base/WpTable.vue:408
	__( 'items', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/base/WpTable.vue:409
	__( 'No items found', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/base/Editor.vue:133
	__( 'Search for an item...', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/base/Editor.vue:134
	...
	// Reference: src/vue/pages/local-seo/views/lite/opening-hours/OpeningHours.vue:47
	...
	// Reference: src/vue/pages/dashboard/views/Main.vue:241
	__( 'User Access Control', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/about/views/GettingStarted.vue:147
	// Reference: src/vue/pages/dashboard/views/Main.vue:243
	...
	// Reference: src/vue/pages/dashboard/views/Main.vue:244
	...
	// Reference: src/vue/pages/local-seo/views/lite/locations/Locations.vue:48
	__( 'Local Business Schema', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-seo/views/lite/locations/Locations.vue:49
	// Reference: src/vue/pages/local-seo/views/lite/maps/Maps.vue:43
	...
	// Reference: src/vue/pages/local-seo/views/pro/opening-hours/Activate.vue:25
	// Reference: src/vue/pages/local-seo/views/pro/opening-hours/OpeningHours.vue:215
	// Reference: src/vue/pages/local-seo/views/pro/opening-hours/Update.vue:25
	...
	// Reference: src/vue/pages/link-assistant/views/Settings.vue:139
	__( 'Link Settings', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:142
	__( 'Select which Post Types you want to enable Link Assistant for.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:143
	__( 'Post Statuses', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:144
	__( 'Include All Post Statuses', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:145
	__( 'Select which Post Statuses you want to enable Link Assistant for.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:146
	__( 'Number of Sentences to Skip at Beginning', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:152
	__( 'Affiliate Link Prefix', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/link-assistant/views/Settings.vue:155
	/* Translators: 1 - The plugin name ("AIOSEO"). */
	...
	// Reference: src/vue/pages/link-assistant/views/Settings.vue:159
	...
	// Reference: src/vue/pages/link-assistant/views/partials/overview/LinkingOpportunities.vue:110
	...
	// Reference: src/vue/pages/local-seo/views/pro/maps/Activate.vue:25
	// Reference: src/vue/pages/local-seo/views/pro/maps/Maps.vue:102
	// Reference: src/vue/pages/local-seo/views/pro/maps/Update.vue:25
	__( 'Google Maps API Key', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:102
	/* Translators: 1 - Learn more link. */
	__( 'Use the following PHP code anywhere in your theme to display the location info. %1$s', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:106
	__( 'Locations Settings', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:108
	/* Translators: 1 - The plugin short name ("AIOSEO"). */
	__( 'Whether your business has multiple locations, or just one, %1$s makes it easy to configure and display relevant information about your local business. You can use the custom-built tools below, or you can use the Locations custom post type (multiple locations only) to generate relevant and necessary information for search engines or for your customers.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:110
	__( 'Use the %1$sLocations%2$s Post Type in the menu on the left to start adding your locations.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:112
	/* Translators: 1 - The plugin short name ("AIOSEO"), 2 - The plugin short name ("AIOSEO"). */
	__( 'Multiple Locations feature is available only for %1$s Pro users. Upgrade to Pro and unlock all %2$s features!', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:92
	/* Translators: 1 - Learn more link. */
	__( 'Use the following shortcode to display the location info. %1$s', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-seo/views/pro/locations/Locations.vue:97
	/* Translators: 1 - Opening HTML link tag, 2 - Closing HTML link tag, 3 - The plugin short name ("AIOSEO") */
	__( 'To add this widget, visit the %1$swidgets page%2$s and look for the "%3$s Local - Business Info" widget.', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/pages/local-seo/views/lite/maps/Maps.vue:42
	__( 'Driving Directions', 'all-in-one-seo-pack' ),
