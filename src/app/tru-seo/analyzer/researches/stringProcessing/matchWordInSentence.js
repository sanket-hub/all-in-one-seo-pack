...
const isWordInSentence = function (word, sentence) {
	...
	const previousCharacter = characterInBoundary(sentence[occurrenceStart - 1]) || 0 === occurrenceStart
