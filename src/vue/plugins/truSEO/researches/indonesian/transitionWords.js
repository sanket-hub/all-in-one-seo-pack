...
const singleWords = [ 'adakalanya', 'agak', 'agar', 'akhirnya', 'alhasil', 'andaikan', 'bahkan',
...
const multipleWords = [  'agar supaya', 'akan tetapi', 'apa lagi', 'asal saja', 'bagaimanapun juga', 'bahkan jika',
