...
const singleWords = [ 'accordingly', 'additionally', 'afterward', 'afterwards', 'albeit', 'also', 'although', 'altogether',
	...
	'whereas', 'while' ]
const multipleWords = [ 'above all', 'after all', 'after that', 'all in all', 'all of a sudden', 'all things considered',
