 ...
 *
 * @returns {void|Object|*} The combined settings object to be used.
 */
function loadSettings (type, userSettings) {
	...
	if (
		'characters_excluding_spaces' !== settings.type &&
		'characters_including_spaces' !== settings.type
	) {
		settings.type = 'words'
	}
 ...
 *
 * @returns {Array|{index: number, input: string}} The matched string.
 */
