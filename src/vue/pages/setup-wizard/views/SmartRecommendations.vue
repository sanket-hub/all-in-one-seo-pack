	...
	data () {
		return {
			...
			strings      : {
				...
				description               : this.$t.sprintf(this.$t.__('Get helpful suggestions from %1$s on how to optimize your website content, so you can rank higher in search results.', this.$td), process.env.VUE_APP_SHORT_NAME),
				...
				// Translators: 1 - Plugin short name ("AIOSEO").
				helpMakeAioseoBetter      : this.$t.sprintf(this.$t.__('Help make %1$s better for everyone', this.$td), process.env.VUE_APP_SHORT_NAME),
