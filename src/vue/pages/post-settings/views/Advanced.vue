	...
	data () {
		return {
			strings : {
				...
				priorityFrequencyUpsell : this.$t.sprintf(this.$t.__('This feature is only for licensed %1$s users. %2$s', this.$td), `<strong>${process.env.VUE_APP_SHORT_NAME} Pro</strong>`, this.$links.getUpsellLink('post-advanced', this.$constants.GLOBAL_STRINGS.learnMore, 'priority-frequency', true)),
